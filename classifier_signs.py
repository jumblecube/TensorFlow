...
# Step 1: Convolution
conv2d_l1 = conv_2d(input_layer, 100, 7, activation='relu', name='conv2d_l1')

# Step 2: Max pooling
max_pool_l1 = max_pool_2d(conv2d_l1, 2, name='max_pool_l1')

# Step 3: Convolution again
conv2d_l2 = conv_2d(max_pool_l1, 150, 4, activation='relu', name='conv2d_l2')

# Step 4: Max pooling
max_pool_l2 = max_pool_2d(conv2d_l2, 2, name='max_pool_l2')

# Step 5: Convolution yet again
conv2d_l3 = conv_2d(max_pool_l2, 250, 4, activation='relu', name='conv2d_l3')
